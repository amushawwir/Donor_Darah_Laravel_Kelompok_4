        ...
        <nav class="header-nav navbar navbar-default nav-style">
            ...
            <div class="collapse navbar-collapse" id="spark-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="{{ url('/donors') }}">Daftar Pendonor</a></li>
                    <li><a href="{{ url('/camp') }}">Jadwal</a></li>
                    <li><a href="{{ url('/center') }}">Bank Darah</a></li>
                    <li><a href="{{ url('/request-blood') }}">Formulir</a></li>
                    <li><a href="{{ url('/support') }}">Kontak</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="{{ url('/home') }}"><i class="fa fa-btn fa-envelope"></i>Pesan</a></li>
                            <li><a href="{{ url('/change-password') }}"><i class="fa fa-btn fa-asterisk"></i>Reset Password</a></li>
                            <li><a href="{{ url('/settings') }}"><i class="fa fa-btn fa-cogs"></i>Edit Profile</a></li>
                            @if (Auth::user()->is_admin == 1)
                            <li><a href="{{ url('/admin') }}"><i class="fa fa-btn fa-user-secret"></i> Dashboard Admin</a></li>
                            @endif
